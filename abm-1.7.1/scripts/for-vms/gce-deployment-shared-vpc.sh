...
gcloud compute --project=$SHARED_VPC_PROJECT_ID firewall-rules create abm-gce-v171-allow-ssh-ingress-from-iap --direction=INGRESS --network=$VPC_NAME --action=ALLOW --source-ranges=35.235.240.0/20 --target-tags=abm-gce-v171 --rules=tcp:22 || :
