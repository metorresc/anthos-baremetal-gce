...
gcloud compute instances create baremetal-workstation \
...
gcloud compute instances create baremetal-controlplane1 \
        --image-family=ubuntu-2004-lts --image-project=ubuntu-os-cloud \
        --zone=${ZONE} \
        --boot-disk-size 200G \
        --boot-disk-type pd-ssd \
...
gcloud compute instances create baremetal-controlplane2 \
        --image-family=ubuntu-2004-lts --image-project=ubuntu-os-cloud \
        --zone=${ZONE} \
        --boot-disk-size 200G \
        --boot-disk-type pd-ssd \
...
gcloud compute instances create baremetal-controlplane3 \
        --image-family=ubuntu-2004-lts --image-project=ubuntu-os-cloud \
        --zone=${ZONE} \
        --boot-disk-size 200G \
        --boot-disk-type pd-ssd \
...
gcloud compute instances create baremetal-workernode1 \
        --image-family=ubuntu-2004-lts --image-project=ubuntu-os-cloud \
        --zone=${ZONE} \
        --boot-disk-size 200G \
        --boot-disk-type pd-ssd \
...
gcloud compute instances create baremetal-workernode2 \
        --image-family=ubuntu-2004-lts --image-project=ubuntu-os-cloud \
        --zone=${ZONE} \
        --boot-disk-size 200G \
        --boot-disk-type pd-ssd \
